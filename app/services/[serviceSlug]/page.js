...
const servicesData = {
  ...
  'field-supervisor': {
    ...
    description: 'Field Supervisors act as the critical link between management and ground staff. They manage daily guard deployment, conduct surprise day and night checks, verify attendance and uniform compliance, and ensure all security protocols are followed flawlessly across multiple facilities.',
    idealFor: [
    ...
    metaTitle: 'Security Field Supervisor | ScoutX Protection Group',
    metaDesc: 'Expert security field supervisors to oversee guard deployments, conduct audits, and manage site security across Delhi NCR.',
  },
  'pso': {
