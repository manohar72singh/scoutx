      ...
      <section className="py-10 px-4 sm:px-6" style={{ background: '#0B0B0D', borderBottom: '1px solid rgba(192,192,192,0.1)' }}>
        <div className="max-w-5xl mx-auto grid sm:grid-cols-3 gap-4">
          <FadeIn delay={0.1} direction="up">
            <a href="tel:+918682066666" title="Call Director Ashok Choudhary" className="card-dark p-5 text-center hover:border-[#4A8FD4] hover:shadow-[0_0_15px_rgba(74,143,212,0.2)] hover:-translate-y-1 transition-all duration-300 group block">
          ...
          <FadeIn delay={0.2} direction="up">
            <a href="tel:+917611865555" title="Call Director Anil Choudhary" className="card-dark p-5 text-center hover:border-[#4A8FD4] hover:shadow-[0_0_15px_rgba(74,143,212,0.2)] hover:-translate-y-1 transition-all duration-300 group block">
              <div className="text-3xl mb-2 group-hover:scale-110 transition-transform">📞</div>
          ...
          <FadeIn delay={0.3} direction="up">
            <a
              ...
              title="Chat with ScoutX on WhatsApp"
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-3 gap-8">
          ...
          <FadeIn direction="right" delay={0.3} className="space-y-6">
            ...
            <div className="card-dark p-6 space-y-3 group hover:border-[#2E6FBF]/50 transition-all duration-300">
              ...
              <a href="mailto:scoutxsecurity@gmail.com" title="Email ScoutX" className="flex items-center gap-2 text-[#A8A8A8] hover:text-white text-sm transition-colors">
